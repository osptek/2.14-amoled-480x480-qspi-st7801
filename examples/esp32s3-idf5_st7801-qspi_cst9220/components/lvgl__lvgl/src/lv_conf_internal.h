...
/*If running without lv_conf.h add typedefs with default value*/
    ...
    #ifndef LV_ANALOGCLOCK_TEXT_SELECTION
        #ifdef CONFIG_LV_ANALOGCLOCK_TEXT_SELECTION
            #define LV_ANALOGCLOCK_TEXT_SELECTION CONFIG_LV_ANALOGCLOCK_TEXT_SELECTION
        #else
            #define LV_ANALOGCLOCK_TEXT_SELECTION 1 /*Enable selecting text of the analogclock*/
        #endif
    #endif
#endif
...
#endif
#if LV_USE_CAROUSEL
    #ifndef LV_CAROUSEL_TEXT_SELECTION
        #ifdef CONFIG_LV_CAROUSEL_TEXT_SELECTION
            #define LV_CAROUSEL_TEXT_SELECTION CONFIG_LV_CAROUSEL_TEXT_SELECTION
        #else
            #define LV_CAROUSEL_TEXT_SELECTION 1 /*Enable selecting text of the carousel*/
        #endif
    #endif
#endif
    ...
    #ifndef LV_TEXTPROGRESS_TEXT_SELECTION
        #ifdef CONFIG_LV_TEXTPROGRESS_TEXT_SELECTION
            #define LV_TEXTPROGRESS_TEXT_SELECTION CONFIG_LV_TEXTPROGRESS_TEXT_SELECTION
        #else
            #define LV_TEXTPROGRESS_TEXT_SELECTION 1 /*Enable selecting text of the textprogress*/
        #endif
    #endif
#endif
